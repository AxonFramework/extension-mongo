...
Thank you for your interest in contributing to the Axon Framework Mongo Extension. To make sure using Axon is a smooth
...
1. You can report any bugs, feature requests or ideas about improvements on
   our [issue page](https://github.com/AxonFramework/extension-mongo/issues/new/choose). All ideas are welcome. Please
...
To sign the CLA, visit: https://cla-assistant.io/AxonFramework/extension-mongo
