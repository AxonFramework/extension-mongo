...
import org.axonframework.extensions.mongo.eventsourcing.eventstore.AbstractMongoEventStorageStrategy;
...
public class DocumentPerCommitStorageStrategy extends AbstractMongoEventStorageStrategy {
    ...
    protected Long extractHighestSequenceNumber(Document document) {
        return (Long) document.get(commitEntryConfiguration.lastSequenceNumberProperty());
    }
