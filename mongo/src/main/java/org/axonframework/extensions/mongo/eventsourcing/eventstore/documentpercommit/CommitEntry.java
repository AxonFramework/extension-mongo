...
public class CommitEntry {
    ...
    public CommitEntry(Document dbObject, CommitEntryConfiguration commitConfiguration,
        ...
        this.firstTimestamp = ((Date) dbObject.get(commitConfiguration.firstTimestampProperty())).toInstant();
        this.lastTimestamp = ((Date) dbObject.get(commitConfiguration.lastTimestampProperty())).toInstant();
